...
import com.andrea.finalproyectott.databinding.FragmentNivelesCuidadorBinding
...
class NivelesCuidadorFragment : Fragment() {
    ...
    private var _binding: FragmentNivelesCuidadorBinding? = null
    private val binding get() = _binding!!

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
                              savedInstanceState: Bundle?): View? {
        activity?.setTitle(R.string.niveles_fragment_string)
        _binding = FragmentNivelesCuidadorBinding.inflate(inflater, container, false)
